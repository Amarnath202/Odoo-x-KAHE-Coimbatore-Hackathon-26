...
import {
  Truck, Plus, Search, Eye, Trash2,
  CheckCircle, Clock, Package, TrendingUp, XCircle,
} from 'lucide-react';
...
const FILTER_TABS = [
  ...
  { label: 'Fully Received',     value: 'Done' },
...
export default function Purchase() {
  ...
  const orders = getStore(STORES.PURCHASE_ORDERS);
  ...
  const handleDelete = (id) => {
    ...
    setStore(STORES.PURCHASE_ORDERS, updated);
    addAuditLog({
      user: user?.name, role: user?.role,
      module: 'Purchase', action: 'Deleted',
      reference: id,
    });
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            {orders.length} orders · {formatINR(kpi.totalValue)} total value
          </p>
        </div>
              ...
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={7} className="py-0">
                    <EmptyState
                      ...
                      action={
                        !search && (
                          <Link to="/purchase/create" className="btn-primary btn-sm mt-2">
                ...
                filtered.map((order, i) => (
                  ...
                  >
                    ...
                    <td>
                      <span className="font-medium text-text-primary">{order.vendor}</span>
                    </td>
          ...
          >
            ...
            >
              <div className="modal-header">
                <h2 className="text-base font-semibold text-text-primary">Delete Purchase Order</h2>
              ...
              <div className="modal-body">
                <p className="text-sm text-text-secondary">
                  ...
                  <span className="font-semibold text-primary">{deleteId}</span>?
