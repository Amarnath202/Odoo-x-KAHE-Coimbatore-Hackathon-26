...
async function main() {
  ...
  const users = [
    { id: 'user0001-0000-0000-0000-000000000001', name: 'System Admin', email: 'admin@shivfurniture.com', role: Role.ADMIN },
  ...
  console.log('\n📋 Demo Login Credentials (all passwords: Admin@123):');
  console.log('  admin@shivfurniture.com     → ADMIN');
